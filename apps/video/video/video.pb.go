...
var file_video_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x50, 0x43, 0x12, 0x38, 0x0a, 0x07, 0x47, 0x65,
...
var file_video_proto_depIdxs = []int32{
	...
	5, // 2: video.VideoRPC.GetFeed:input_type -> video.GetFeedRequest
	3, // 3: video.VideoRPC.GetPublishVideoList:input_type -> video.GetPublishVideoListRequest
	1, // 4: video.VideoRPC.PublishVideo:input_type -> video.PublishVideoRequest
	6, // 5: video.VideoRPC.GetFeed:output_type -> video.GetFeedResponse
	4, // 6: video.VideoRPC.GetPublishVideoList:output_type -> video.GetPublishVideoListResponse
	2, // 7: video.VideoRPC.PublishVideo:output_type -> video.PublishVideoResponse
